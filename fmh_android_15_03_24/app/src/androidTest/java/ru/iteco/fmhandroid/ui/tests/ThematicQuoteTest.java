...
public class ThematicQuoteTest {
    ...
    //  ТC - 1 - Проверка корректности отображения элементов экрана,во вкладке "Love is all", мобильного приложения "Мобильный хоспис" (Позитивный).
    @Test
    @Story("TC - 1")
    ...
    //  ТC - 2 - Развернуть/свернуть тематическую цитату, во вкладке "Love is all", мобильного приложения "Мобильный хоспис" (Позитивный).
    @Test
    @Story("TC - 2")
